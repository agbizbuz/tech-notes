---
title: "uv cheatsheet"
source: "https://mathspp.com/blog/uv-cheatsheet"
author:
  - "[[Rodrigo Girão Serrão]]"
published: 2025-09-06
created: 2026-02-14
description: "Cheatsheet with the most common and useful uv commands to manage projects and dependencies, publish projects, manage tools, and more."
tags:
  - "clippings"
---
...
Make your script executable and add the uv shebang at the very first line of the script: `#!/usr/bin/env -S uv run`. This way, you can run your script directly as `./myscript.py` instead of having to write `uv run myscript.py`.
...
- uv documentation, [https://docs.astral.sh/uv/](https://docs.astral.sh/uv/) \[last accessed 06-09-2025\];
